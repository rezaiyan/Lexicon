...
class CooldownVisibilityTest {
    ...
    fun criticalTest_wordInCooldown_notInDueCards_butVisibleInBucket() = runTest {
        ...
        println("\n1  SETUP: Word at Level 1, due for review")
        ...
        println("\n2  BEFORE REVIEW: Verify word in due cards")
        ...
        println("\n3  BEFORE REVIEW: Verify word in Level 1 bucket")
        ...
        println("\n6  VERIFY: Word entered cooldown period")
        ...
        println("\n7  CRITICAL: Word NOT in due cards (during cooldown)")
        ...
        println("\n8  CRITICAL: Word IS visible in Level 2 bucket")
        ...
        println("\n9  VERIFY: Word removed from Level 1 bucket")
    ...
    fun multipleCooldownWords_allVisibleInTheirBuckets() = runTest {
        ...
        println("\n1  SETUP: 5 words due for review")
        val now = Clock.System.now().toEpochMilliseconds()
        val words = listOf(
        ...
        println("\n2  ACTION: Review all 5 words (all REMEMBERED)")
        ...
        println("\n3  VERIFY: All words advanced one level")
        ...
        println("\n4  CRITICAL: All words in cooldown, none in due cards")
        val dueCardsAfter = getDueWordsUseCase().first()
        ...
        println("\n5  CRITICAL: All words visible in their new buckets")
    ...
    fun mixedState_someDue_someInCooldown() = runTest {
        ...
        println("\n2  VERIFY: Due cards contains only due words")
        ...
        println("\n3  CRITICAL: Level 2 bucket shows ALL 4 words")
