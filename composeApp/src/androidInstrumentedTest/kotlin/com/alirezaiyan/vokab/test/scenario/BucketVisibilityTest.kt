...
class BucketVisibilityTest {
    ...
    fun scenario_wordMovesFromLevel1ToLevel2_visibleInLevel2Bucket() = runTest {
        ...
        println("\n1️⃣ SETUP: Creating word at Level 1 with 1 repetition")
        ...
        println("\n2️⃣ VERIFY: Word appears in Level 1 bucket (Learning)")
        ...
        println("\n3️⃣ ACTION: User reviews word and responds REMEMBERED")
        ...
        println("\n4️⃣ VERIFY: Word updated in database")
        ...
        println("\n5️⃣ VERIFY: Word is NOT in due cards (cooldown active)")
        ...
        println("\n6️⃣ VERIFY: Word IS visible in Level 2 bucket (Familiarizing)")
        ...
        println("\n7️⃣ VERIFY: Word is NOT in Level 1 bucket anymore")
    ...
    fun scenario_multipleWordsInDifferentBuckets_eachVisibleInCorrectBucket() = runTest {
        ...
        println("\n1️⃣ SETUP: Creating 3 words at different levels")
        val words = listOf(
        ...
        println("\n2️⃣ ACTION: User reviews all words successfully")
        ...
        println("\n3️⃣ VERIFY: Each word in its correct new bucket")
    ...
    fun scenario_wordForgotten_dropsBackToPreviousBucket() = runTest {
        ...
        println("\n1️⃣ SETUP: Creating word at Level 3 (Consolidating)")
        val word = TestUtils.createWord(
            id = 0,
        ...
        println("\n2️⃣ VERIFY: Word in Level 3 bucket")
        ...
        println("\n5️⃣ VERIFY: Word now in Level 1 bucket (Learning)")
        ...
        println("\n6️⃣ VERIFY: Word NOT in Level 3 bucket anymore")
    ...
    fun scenario_realUserFlow_reviewSessionThenViewProgress() = runTest {
        ...
        println("\n1️⃣ SETUP: User has 5 due words")
        val now = Clock.System.now().toEpochMilliseconds()
        val words = listOf(
        ...
        println("\n2️⃣ ACTION: User reviews all words (all REMEMBERED)")
        ...
        println("\n3️⃣ VERIFY: User views Progress screen")
        ...
        println("\n4️⃣ VERIFY: All words visible in their NEW buckets")
